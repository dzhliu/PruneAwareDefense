...
srun python main.py --attack_mode='trigger_generation' --possibility=1 --aggregation='median' --wandb_run_name="trigger_scratch_10_1_median" --using_clip=True --trigger_norm=4 --server_lr=1 
